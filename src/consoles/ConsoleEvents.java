...
public class ConsoleEvents implements ActionListener, FocusListener {
	...
	private ConsoleEvents() {
		...
		// Cr�ation de la fen�tre de logs
		this.frame1 = new JFrame("Evénements Zoo");
		...
		// Pour que l'affichage suive le d�filement de texte
		...
		// Mise en place de la fen�tre (position/taille)
